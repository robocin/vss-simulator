...
namespace Aos {
    ...
    inline Quat::Quat( const btVector3 & xyz, float _w )
    {
        this->setXYZ( xyz );
        this->setW( _w );
    }
    ...
    inline Quat & Quat::setXYZ( const btVector3 & vec )
    {
        mXYZW[0] = vec.getX();
        mXYZW[1] = vec.getY();
        mXYZW[2] = vec.getZ();
    ...
    inline const btVector3 Quat::getXYZ( ) const
    {
        return btVector3( mXYZW[0], mXYZW[1], mXYZW[2] );
    }
    ...
    inline const Quat Quat::rotation( const btVector3 & unitVec0, const btVector3 & unitVec1 )
    {
    ...
    inline const Quat Quat::rotation( float radians, const btVector3 & unitVec )
    {
        float s, c, angle;
        angle = ( radians * 0.5f );
        s = sinf( angle );
    ...
    inline const btVector3 rotate( const Quat & quat, const btVector3 & vec )
    {
