...
inline btVector3::btVector3( const btVector3 & vec )
{
    mX = vec.mX;
    mY = vec.mY;
    mZ = vec.mZ;
...
inline btVector3::btVector3( float _x, float _y, float _z )
{
    mX = _x;
    mY = _y;
    mZ = _z;
...
inline btVector3::btVector3( const Point3 & pnt )
{
    mX = pnt.getX();
    mY = pnt.getY();
    mZ = pnt.getZ();
...
inline btVector3::btVector3( float scalar )
{
    mX = scalar;
    mY = scalar;
    mZ = scalar;
...
inline const btVector3 btVector3::xAxis( )
{
    return btVector3( 1.0f, 0.0f, 0.0f );
}

inline const btVector3 btVector3::yAxis( )
{
    return btVector3( 0.0f, 1.0f, 0.0f );
}

inline const btVector3 btVector3::zAxis( )
{
...
{
    vec = btVector3( fptr[0], fptr[1], fptr[2] );
}
...
inline btVector3 & btVector3::operator =( const btVector3 & vec )
{
    mX = vec.mX;
    mY = vec.mY;
    mZ = vec.mZ;
...
inline btVector3 & btVector3::setX( float _x )
{
    mX = _x;
    return *this;
}

inline float btVector3::getX( ) const
{
    return mX;
}

inline btVector3 & btVector3::setY( float _y )
{
    mY = _y;
    return *this;
}

inline float btVector3::getY( ) const
{
    return mY;
}

inline btVector3 & btVector3::setZ( float _z )
{
    mZ = _z;
    return *this;
}

inline float btVector3::getZ( ) const
{
    return mZ;
}

inline btVector3 & btVector3::setElem( int idx, float value )
{
    *(&mX + idx) = value;
    return *this;
}

inline float btVector3::getElem( int idx ) const
{
    return *(&mX + idx);
}

inline float & btVector3::operator []( int idx )
{
    return *(&mX + idx);
}

inline float btVector3::operator []( int idx ) const
{
    return *(&mX + idx);
}

inline const btVector3 btVector3::operator +( const btVector3 & vec ) const
{
    return btVector3(
        ( mX + vec.mX ),
        ( mY + vec.mY ),
...
inline const Point3 btVector3::operator +( const Point3 & pnt ) const
{
    return Point3(
        ( mX + pnt.getX() ),
        ( mY + pnt.getY() ),
...
inline const btVector3 btVector3::operator *( float scalar ) const
{
    return btVector3(
        ( mX * scalar ),
        ( mY * scalar ),
...
inline btVector3 & btVector3::operator *=( float scalar )
{
    *this = *this * scalar;
    return *this;
}
...
inline const btVector3 btVector3::operator -( ) const
{
    return btVector3(
        -mX,
        -mY,
...
inline Vector4::Vector4( const btVector3 & xyz, float _w )
{
    this->setXYZ( xyz );
    this->setW( _w );
}

inline Vector4::Vector4( const btVector3 & vec )
{
    mX = vec.getX();
    mY = vec.getY();
    mZ = vec.getZ();
...
inline Vector4 & Vector4::setXYZ( const btVector3 & vec )
{
    mX = vec.getX();
    mY = vec.getY();
    mZ = vec.getZ();
...
inline const btVector3 Vector4::getXYZ( ) const
{
...
inline Point3::Point3( const btVector3 & vec )
{
    mX = vec.getX();
    mY = vec.getY();
    mZ = vec.getZ();
...
inline const btVector3 Point3::operator -( const Point3 & pnt ) const
{
    return btVector3(
        ( mX - pnt.mX ),
        ( mY - pnt.mY ),
...
inline const Point3 Point3::operator +( const btVector3 & vec ) const
{
    return Point3(
        ( mX + vec.getX() ),
        ( mY + vec.getY() ),
...
inline Point3 & Point3::operator +=( const btVector3 & vec )
{
    *this = *this + vec;
    return *this;
}
