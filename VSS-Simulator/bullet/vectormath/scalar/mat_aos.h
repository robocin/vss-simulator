...
inline Matrix3::Matrix3( const Quat & unitQuat )
{
    ...
    qzqz2 = ( qz * qz2 );
    qzqw2 = ( qw * qz2 );
    mCol0 = btVector3( ( ( 1.0f - qyqy2 ) - qzqz2 ), ( qxqy2 + qzqw2 ), ( qxqz2 - qyqw2 ) );
    mCol1 = btVector3( ( qxqy2 - qzqw2 ), ( ( 1.0f - qxqx2 ) - qzqz2 ), ( qyqz2 + qxqw2 ) );
    mCol2 = btVector3( ( qxqz2 + qyqw2 ), ( qyqz2 - qxqw2 ), ( ( 1.0f - qxqx2 ) - qyqy2 ) );
}

inline Matrix3::Matrix3( const btVector3 & _col0, const btVector3 & _col1, const btVector3 & _col2 )
{
    mCol0 = _col0;
    mCol1 = _col1;
    mCol2 = _col2;
...
inline Matrix3 & Matrix3::setCol0( const btVector3 & _col0 )
{
    mCol0 = _col0;
    return *this;
}

inline Matrix3 & Matrix3::setCol1( const btVector3 & _col1 )
{
    mCol1 = _col1;
    return *this;
}

inline Matrix3 & Matrix3::setCol2( const btVector3 & _col2 )
{
    mCol2 = _col2;
    return *this;
}

inline Matrix3 & Matrix3::setCol( int col, const btVector3 & vec )
{
    *(&mCol0 + col) = vec;
    return *this;
}

inline Matrix3 & Matrix3::setRow( int row, const btVector3 & vec )
{
...
inline const btVector3 Matrix3::getCol0( ) const
{
    return mCol0;
}

inline const btVector3 Matrix3::getCol1( ) const
{
    return mCol1;
}

inline const btVector3 Matrix3::getCol2( ) const
{
    return mCol2;
}

inline const btVector3 Matrix3::getCol( int col ) const
{
    return *(&mCol0 + col);
}

inline const btVector3 Matrix3::getRow( int row ) const
{
    return btVector3( mCol0.getElem( row ), mCol1.getElem( row ), mCol2.getElem( row ) );
}

inline btVector3 & Matrix3::operator []( int col )
{
    return *(&mCol0 + col);
}

inline const btVector3 Matrix3::operator []( int col ) const
{
    return *(&mCol0 + col);
}
...
{
    return Matrix3(
        btVector3( mat.getCol0().getX(), mat.getCol1().getX(), mat.getCol2().getX() ),
        btVector3( mat.getCol0().getY(), mat.getCol1().getY(), mat.getCol2().getY() ),
        btVector3( mat.getCol0().getZ(), mat.getCol1().getZ(), mat.getCol2().getZ() )
    );
}

inline const Matrix3 inverse( const Matrix3 & mat )
{
    btVector3 tmp0, tmp1, tmp2;
    float detinv;
    ...
    return Matrix3(
        btVector3( ( tmp0.getX() * detinv ), ( tmp1.getX() * detinv ), ( tmp2.getX() * detinv ) ),
        btVector3( ( tmp0.getY() * detinv ), ( tmp1.getY() * detinv ), ( tmp2.getY() * detinv ) ),
        btVector3( ( tmp0.getZ() * detinv ), ( tmp1.getZ() * detinv ), ( tmp2.getZ() * detinv ) )
    );
}
...
inline const btVector3 Matrix3::operator *( const btVector3 & vec ) const
{
    return btVector3(
...
inline const Matrix3 Matrix3::rotationZYX( const btVector3 & radiansXYZ )
{
    ...
    tmp1 = ( sZ * sY );
    return Matrix3(
        btVector3( ( cZ * cY ), ( sZ * cY ), -sY ),
        btVector3( ( ( tmp0 * sX ) - ( sZ * cX ) ), ( ( tmp1 * sX ) + ( cZ * cX ) ), ( cY * sX ) ),
        btVector3( ( ( tmp0 * cX ) + ( sZ * sX ) ), ( ( tmp1 * cX ) - ( cZ * sX ) ), ( cY * cX ) )
    );
}

inline const Matrix3 Matrix3::rotation( float radians, const btVector3 & unitVec )
{
    ...
    oneMinusC = ( 1.0f - c );
    return Matrix3(
        btVector3( ( ( ( x * x ) * oneMinusC ) + c ), ( ( xy * oneMinusC ) + ( z * s ) ), ( ( zx * oneMinusC ) - ( y * s ) ) ),
        btVector3( ( ( xy * oneMinusC ) - ( z * s ) ), ( ( ( y * y ) * oneMinusC ) + c ), ( ( yz * oneMinusC ) + ( x * s ) ) ),
        btVector3( ( ( zx * oneMinusC ) + ( y * s ) ), ( ( yz * oneMinusC ) - ( x * s ) ), ( ( ( z * z ) * oneMinusC ) + c ) )
    );
}
...
inline const Matrix3 Matrix3::scale( const btVector3 & scaleVec )
{
    return Matrix3(
        btVector3( scaleVec.getX(), 0.0f, 0.0f ),
        btVector3( 0.0f, scaleVec.getY(), 0.0f ),
        btVector3( 0.0f, 0.0f, scaleVec.getZ() )
    );
}
...
inline Matrix4::Matrix4( const Matrix3 & mat, const btVector3 & translateVec )
{
    mCol0 = Vector4( mat.getCol0(), 0.0f );
    mCol1 = Vector4( mat.getCol1(), 0.0f );
    mCol2 = Vector4( mat.getCol2(), 0.0f );
...
inline Matrix4::Matrix4( const Quat & unitQuat, const btVector3 & translateVec )
{
    Matrix3 mat;
...
inline const Vector4 Matrix4::operator *( const btVector3 & vec ) const
{
    return Vector4(
        ( ( ( mCol0.getX() * vec.getX() ) + ( mCol1.getX() * vec.getY() ) ) + ( mCol2.getX() * vec.getZ() ) ),
        ( ( ( mCol0.getY() * vec.getX() ) + ( mCol1.getY() * vec.getY() ) ) + ( mCol2.getY() * vec.getZ() ) ),
...
inline Matrix4 & Matrix4::setTranslation( const btVector3 & translateVec )
{
    mCol3.setXYZ( translateVec );
    return *this;
}

inline const btVector3 Matrix4::getTranslation( ) const
{
    return mCol3.getXYZ( );
}
...
inline const Matrix4 Matrix4::rotationZYX( const btVector3 & radiansXYZ )
{
    float sX, cX, sY, cY, sZ, cZ, tmp0, tmp1;
    sX = sinf( radiansXYZ.getX() );
    cX = cosf( radiansXYZ.getX() );
...
inline const Matrix4 Matrix4::rotation( float radians, const btVector3 & unitVec )
{
    float x, y, z, s, c, oneMinusC, xy, yz, zx;
    s = sinf( radians );
    c = cosf( radians );
...
inline const Matrix4 Matrix4::scale( const btVector3 & scaleVec )
{
    return Matrix4(
...
inline const Matrix4 Matrix4::translation( const btVector3 & translateVec )
{
    return Matrix4(
        Vector4::xAxis( ),
        Vector4::yAxis( ),
...
inline const Matrix4 Matrix4::lookAt( const Point3 & eyePos, const Point3 & lookAtPos, const btVector3 & upVec )
{
    Matrix4 m4EyeFrame;
...
inline Transform3::Transform3( const btVector3 & _col0, const btVector3 & _col1, const btVector3 & _col2, const btVector3 & _col3 )
{
    mCol0 = _col0;
    mCol1 = _col1;
    mCol2 = _col2;
...
inline Transform3::Transform3( const Matrix3 & tfrm, const btVector3 & translateVec )
{
    this->setUpper3x3( tfrm );
    this->setTranslation( translateVec );
}

inline Transform3::Transform3( const Quat & unitQuat, const btVector3 & translateVec )
{
    this->setUpper3x3( Matrix3( unitQuat ) );
    this->setTranslation( translateVec );
}

inline Transform3 & Transform3::setCol0( const btVector3 & _col0 )
{
    mCol0 = _col0;
    return *this;
}

inline Transform3 & Transform3::setCol1( const btVector3 & _col1 )
{
    mCol1 = _col1;
    return *this;
}

inline Transform3 & Transform3::setCol2( const btVector3 & _col2 )
{
    mCol2 = _col2;
    return *this;
}

inline Transform3 & Transform3::setCol3( const btVector3 & _col3 )
{
    mCol3 = _col3;
    return *this;
}

inline Transform3 & Transform3::setCol( int col, const btVector3 & vec )
{
    *(&mCol0 + col) = vec;
    return *this;
}
...
inline const btVector3 Transform3::getCol0( ) const
{
    return mCol0;
}

inline const btVector3 Transform3::getCol1( ) const
{
    return mCol1;
}

inline const btVector3 Transform3::getCol2( ) const
{
    return mCol2;
}

inline const btVector3 Transform3::getCol3( ) const
{
    return mCol3;
}

inline const btVector3 Transform3::getCol( int col ) const
{
    return *(&mCol0 + col);
}
...
inline btVector3 & Transform3::operator []( int col )
{
    return *(&mCol0 + col);
}

inline const btVector3 Transform3::operator []( int col ) const
{
    return *(&mCol0 + col);
}
...
{
    btVector3 tmp0, tmp1, tmp2, inv0, inv1, inv2;
    float detinv;
    ...
    inv0 = btVector3( ( tmp0.getX() * detinv ), ( tmp1.getX() * detinv ), ( tmp2.getX() * detinv ) );
    inv1 = btVector3( ( tmp0.getY() * detinv ), ( tmp1.getY() * detinv ), ( tmp2.getY() * detinv ) );
    inv2 = btVector3( ( tmp0.getZ() * detinv ), ( tmp1.getZ() * detinv ), ( tmp2.getZ() * detinv ) );
    return Transform3(
        inv0,
        inv1,
        inv2,
        btVector3( ( -( ( inv0 * tfrm.getCol3().getX() ) + ( ( inv1 * tfrm.getCol3().getY() ) + ( inv2 * tfrm.getCol3().getZ() ) ) ) ) )
    );
}

inline const Transform3 orthoInverse( const Transform3 & tfrm )
{
    btVector3 inv0, inv1, inv2;
    inv0 = btVector3( tfrm.getCol0().getX(), tfrm.getCol1().getX(), tfrm.getCol2().getX() );
    inv1 = btVector3( tfrm.getCol0().getY(), tfrm.getCol1().getY(), tfrm.getCol2().getY() );
    inv2 = btVector3( tfrm.getCol0().getZ(), tfrm.getCol1().getZ(), tfrm.getCol2().getZ() );
    return Transform3(
        inv0,
        inv1,
        inv2,
...
inline const btVector3 Transform3::operator *( const btVector3 & vec ) const
{
    return btVector3(
        ( ( ( mCol0.getX() * vec.getX() ) + ( mCol1.getX() * vec.getY() ) ) + ( mCol2.getX() * vec.getZ() ) ),
        ( ( ( mCol0.getY() * vec.getX() ) + ( mCol1.getY() * vec.getY() ) ) + ( mCol2.getY() * vec.getZ() ) ),
...
inline Transform3 & Transform3::setTranslation( const btVector3 & translateVec )
{
    mCol3 = translateVec;
    return *this;
}

inline const btVector3 Transform3::getTranslation( ) const
{
    return mCol3;
}
...
inline const Transform3 Transform3::rotationZYX( const btVector3 & radiansXYZ )
{
    float sX, cX, sY, cY, sZ, cZ, tmp0, tmp1;
    sX = sinf( radiansXYZ.getX() );
    cX = cosf( radiansXYZ.getX() );
...
inline const Transform3 Transform3::rotation( float radians, const btVector3 & unitVec )
{
...
inline const Transform3 Transform3::scale( const btVector3 & scaleVec )
{
    return Transform3(
        btVector3( scaleVec.getX(), 0.0f, 0.0f ),
        btVector3( 0.0f, scaleVec.getY(), 0.0f ),
...
inline const Transform3 Transform3::translation( const btVector3 & translateVec )
{
    return Transform3(
        btVector3::xAxis( ),
        btVector3::yAxis( ),
...
inline const Matrix3 outer( const btVector3 & tfrm0, const btVector3 & tfrm1 )
{
    return Matrix3(
        ( tfrm0 * tfrm1.getX( ) ),
        ( tfrm0 * tfrm1.getY( ) ),
...
{
    return Matrix3(
        btVector3( 0.0f, vec.getZ(), -vec.getY() ),
        btVector3( -vec.getZ(), 0.0f, vec.getX() ),
        btVector3( vec.getY(), -vec.getX(), 0.0f )
    );
}
